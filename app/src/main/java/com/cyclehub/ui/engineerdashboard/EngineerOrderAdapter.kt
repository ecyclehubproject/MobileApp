...
class EngineerOrderAdapter(
    ...
    RecyclerView.Adapter<EngineerOrderAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val vendorName = ArrayList<String>()
        myOrdersList.forEach { orderlist ->
            ...
            vendorName.add(
                users.firstOrNull { it.id.toInt() == orderlist.vendorId }?.name ?: ""
            )
        }
        ...
        if (vendorName[position].isNotEmpty()) holder.binding.assignTo.text =
            "Assigned By: ${vendorName[position]}"
